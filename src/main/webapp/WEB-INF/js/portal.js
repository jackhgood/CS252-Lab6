...
var Portal = function(scene, player, object, position, rotation, color, settings) {
	...
	this.frame1.position.copy(this.left).multiplyScalar(1.1*this.radiusX).add(this.position);
	...
	this.frame2.position.copy(this.left).multiplyScalar(-1.1*this.radiusX).add(this.position);
	...
	this.frame3.position.copy(this.up).multiplyScalar(1.1*this.radiusY).add(this.position);
	...
	this.frame4.position.copy(this.up).multiplyScalar(-1.1*this.radiusY).add(this.position);
